...
echo "Adding more hotels to the database...\n\n";
...
echo "\nTotal cities now available: ";
$city_result = db_query($conn, "SELECT COUNT(DISTINCT city) as count FROM hotels");
if ($city_result) {
    $city_count = db_fetch_assoc($city_result)['count'];
    echo "$city_count\n";
}
?>